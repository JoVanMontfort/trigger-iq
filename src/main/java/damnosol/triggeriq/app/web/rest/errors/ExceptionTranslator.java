...
import damnosol.triggeriq.app.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        ...
        if (
            ex instanceof damnosol.triggeriq.app.service.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof damnosol.triggeriq.app.service.InvalidPasswordException
